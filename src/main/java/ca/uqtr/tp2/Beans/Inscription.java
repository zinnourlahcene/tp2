package ca.uqtr.tp2.Beans;

import ca.uqtr.tp2.Persistence.annotation.Column;
import ca.uqtr.tp2.Persistence.annotation.Ignore;
import ca.uqtr.tp2.Persistence.annotation.Join;
import ca.uqtr.tp2.Persistence.annotation.PrimaryKey;
...
@Table(name="inscription", pk = "inscriptionid")
public class Inscription {
	...
	/**
	 * Initializes a newly created Registration object so that it represents a Inscription.
	 *
	 ...
	 * @param student
	 */
	public Inscription(int studentId, Course course, Student student) {
		super();
