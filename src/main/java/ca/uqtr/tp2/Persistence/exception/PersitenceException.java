...
public class PersitenceException extends Exception {
	...
	public PersitenceException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	...
	public PersitenceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
